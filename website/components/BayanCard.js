    ...
    <div className="bg-white rounded-2xl shadow-sm border border-[#e8dfce] hover:border-[#c4a962] hover:shadow-md transition-all overflow-hidden">
      ...
      <div className="flex justify-between items-center p-5">
        <div className="flex-1 min-w-0 pr-4">
          <h3 className="font-bold text-lg md:text-xl text-[#1f4e3d] leading-snug truncate">
            {bayan.title}
          </h3>
        ...
        {bayan.audioUrl && (
          <button
            ...
            className={`w-12 h-12 flex-shrink-0 rounded-full flex items-center justify-center transition-all duration-300 shadow-sm border
              ${playing
      ...
      {/* Inline Audio Player — slides open when playing */}
